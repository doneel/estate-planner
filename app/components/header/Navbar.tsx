        ...
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <button
              ...
              type="button"
              className="ml-1 inline-flex hidden items-center rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 lg:hidden"
